export const sidebarItems = [
  ...
  { label: "Raw Material Supplier", icon: "briefcase", path: "/raw-material-supplier" },
  { label: "Project Goods Supplier", icon: "briefcase", path: "/suppliers" },
  ...
  { label: "Material Supplier Payment", icon: "wallet", path: "/supplier-payments" },
  { label: "Goods Supplier Payment", icon: "wallet", path: "/goods-supplier-payments" },
