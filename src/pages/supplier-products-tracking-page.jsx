        ...
        current.map((entry) =>
          entry.id === editingId
            ? {
                ...
                quantitySupplied: formValues.quantitySupplied,
          ...
          <table className="w-full min-w-[980px] table-fixed border-collapse text-left">
            <thead>
              <tr className="border-b border-[#314058] text-[10px] uppercase tracking-[0.16em] text-[#7f8ea6]">
                ...
                <th className="w-[18%] pb-3 font-medium">Quantity Supplied</th>
                <th className="w-[13%] pb-3 font-medium">Quality Status</th>
